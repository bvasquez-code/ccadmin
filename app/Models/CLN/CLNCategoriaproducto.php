...
class CLNCategoriaproducto extends Model
{
    ...
    public function Set_Categoria_Producto($p_request = null,int $p_Id_Usuario,int $p_Id_Empresa,int $p_Id_Tienda,
                                           string $p_User,string $p_Password)
    {
        ...
        $l_ObjData = [];
        $ListCategoriaProducto = [];
        array_push($ListCategoriaProducto,$p_request);
        $l_ObjData["ListCategoriaProducto"] = $ListCategoriaProducto;
        $l_ObjData["Tip_Carga"] = 1;
    ...
    public function Get_Categoria_Producto(ENDataService $p_ENDataService,int $p_Id_Usuario,int $p_Id_Empresa,int $p_Id_Tienda,string $p_User,string $p_Password)
    {
        $l_Rpt = new ENResponse;
        $l_ENRequestService = new ENRequestService;
        $l_SEOrquestador = new SEOrquestador;        
