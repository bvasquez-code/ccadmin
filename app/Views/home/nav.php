<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="<?php echo base_url('sistema');?>" class="navbar-brand"><span class="navbar-logo"></span>CCADMIN</a>
				...
				<input type="hidden" id="hurl_base" name="hurl_base" value="<?php echo base_url()?>">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown navbar-user">
						...
						<ul class="dropdown-menu animated fadeInLeft">
							...
							<li class="divider"></li>
							<li><a href="javascript:;" id="cerrar-session" >Cerrar sesión</a></li>
						</ul>
					</li>
				</ul>
