...
<div class="row">
    <div class="col-md-4">
        <a id="btn-nuevo" href="<?=base_url("public/producto/crear")?>" class="btn btn-primary btn-block m-b-5"><i class="fa fa-cogs"></i> NUEVO</a>            
    </div>
    <div class="col-md-6"></div>
    <div class="col-md-2 col-sm-2">
        <a class="btn btn-success" id="btn-carga-masiva" style="width: 100%;"><i class="ace-icon fa fa-file-excel-o"></i>CARGA MASIVA</a>
    </div>
</div>
<br>
<!-- begin row -->
