...
<div class="row">
    <div class="col-md-4">
        <a id="btn-nuevo" href="<?=base_url("public/preventa/crear")?>" class="btn btn-primary btn-block m-b-5"><i class="fa fa-cogs"></i> NUEVO</a>            
    </div>
</div>
<br>
<!-- begin row -->
...
$(document).ready(function() {
    ...
    function Get_PreVenta(p_Cod_Venta = "",p_Cod_ClienteDoc="",p_Des_VentaBus="",p_Fec_VentaIni = "",p_Fec_VentaFin = "")
    {
        var l_OpcionesHtml = "";
        var l_DataTabla = [];
        var l_RowTabla = [];
    ...
    function Get_Recuperar_Preventa( p_Id_Venta = 0 )
    {
        ...
        var l_RowTabla = [];
        var l_OpcionesTabla = [];
        var l_Tip_Busqueda = 2; // Detalle de la venta
    ...
    $("#btn-buscar").click(function(e){
        ...
        g_Num_Pagina = 1;
        Get_PreVenta($("#txt-Cod_Venta").val(),$("#txt-Cod_ClienteDoc").val(),"",$("#txt-Fec_VentaIni").val(),$("#txt-Fec_VentaFin").val());
    ...
    $("#txt-busqueda").keypress(function(e) {
        ...
        if(code==13){
            g_Num_Pagina = 1;
            Get_PreVenta($("#txt-Cod_Venta").val(),$("#txt-Cod_ClienteDoc").val(),$("#txt-busqueda").val(),$("#txt-Fec_VentaIni").val(),$("#txt-Fec_VentaFin").val());
        }
    });
