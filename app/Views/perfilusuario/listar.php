...
<div class="row">
    <div class="col-md-4">
        <a id="btn-nuevo" href="<?=base_url("public/perfilusuario/crear")?>" class="btn btn-primary btn-block m-b-5"><i class="fa fa-cogs"></i> NUEVO</a>            
    </div>
</div>
<br>
<!-- begin row -->
<div class="col-xs-12">
 ...
 <script src="<?php echo base_url('assets/js_sistema/perfilusuario/backend.perfilusuario.js'); ?>"></script>
  <!-- ================== END JS FUNCIONES ================== -->
...
<select class="form-control lst-opciones" id="1" id2="1" name="opciones" data-style="btn-primary" data-live-search="true"><option value="null">
